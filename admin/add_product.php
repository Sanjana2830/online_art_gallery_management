         ...
         <div class="container divform">
            ...
            <form action="" method="post" name="f1" enctype="multipart/form-data">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="det" name="a6" placeholder="Enter Art Detail" required>
               </div>
               <div class="form-group">
                  <label for="cod">Unique Code:</label>
                  <input type="text" class="form-control" id="cod" name="a7" placeholder="Enter Unique Code" required>
               </div>
               <br>
         ...
         if (mysqli_query($con, $sql)) {
            if ($result) 
         	 ...
         	 window.location.assign('add_product.php')
               ...
               {
                  echo "<script> alert('art already exists !!!')</script>";
               } 
               else 
               {
