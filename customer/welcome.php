      ...
      <div class="row">
         <?php
            	...
            	while($result=mysqli_fetch_array($run))
            {
            	...
            	<div style='background:black;color:#fff;font-size:16px;font-weight:bold;' class='text-center text-capitalize'><span>$result[1] |   <span style='text-decoration:line-through;'>Less(Rs.):$result[4]</span> | Rs.$result[3]</span></div><div class='product-des' style='background:#000;color:#fff;font-size: 16px;height:0px;overflow-y:hidden;' class='text-left'><span>$result[6]</span></div><div class='text-center'style='background:black;font-size: 20px;'><a href='bookingbycustomer.php?id=$result[0]' style='color:#fff'>Book Now</a></div></div></div>";
