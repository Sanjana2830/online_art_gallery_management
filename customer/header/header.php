...
<html lang="en">
  ...
  <head>
   ...
   <title>Customer - <?php echo $_SESSION["name"]; ?> - The Art Club</title>
 ...
 <a href="javascript:;" style="padding: 0px 0;color:#000;margin-right: 3em;">
                  ...
                  <form class="navbar-form navbar-left" action="welcome.php" method="post">
                    ...
                    <div class="input-group" >
                      ...
                      <input list="browsers" name="proname" type="text" class="form-control" style="color: white; max-height: 35px;" placeholder="Search Product" required>
